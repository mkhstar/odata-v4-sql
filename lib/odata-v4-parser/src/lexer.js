...
exports.Lexer = exports.LexerToken = exports.Token = exports.LexerTokenType = exports.TokenType = void 0;
...
var Lexer;
(function (Lexer) {
    Lexer.Token = exports.LexerToken;
    Lexer.TokenType = exports.LexerTokenType;
    function tokenize(value, index, next, tokenValue, tokenType, metadataContextContainer) {
        let token = new exports.LexerToken({
            position: index,
            next: next,
            value: tokenValue,
            type: tokenType,
